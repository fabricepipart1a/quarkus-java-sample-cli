...
class TestGitHub {
  ...
  void listBranches(LaunchResult result) {
  ...
  void listCommits(LaunchResult result) {
  ...
  void listBranchesWithParameters(LaunchResult result) {
